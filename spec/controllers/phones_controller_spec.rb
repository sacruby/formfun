  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved phone as @phone" do
        ...
        post :create, {:phone => { "number" => "invalid value" }}, valid_session
        assigns(:phone).should be_a_new(Phone)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested phone" do
        ...
        Phone.any_instance.should_receive(:update).with({ "number" => "MyString" })
        put :update, {:id => phone.to_param, :phone => { "number" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the phone as @phone" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Phone.any_instance.stub(:save).and_return(false)
        put :update, {:id => phone.to_param, :phone => { "number" => "invalid value" }}, valid_session
        assigns(:phone).should eq(phone)
      end
